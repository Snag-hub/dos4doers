                        ...
                        <SettingCard>
                            ...
                            <div className="space-y-3">
                                ...
                                <FeedbackWidget trigger={
                                    <div className="flex items-center justify-between p-4 rounded-2xl bg-blue-50/50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800/50 hover:bg-blue-100/50 dark:hover:bg-blue-900/30 transition-colors group cursor-pointer w-full">
                                        <div className="flex items-center gap-3">
