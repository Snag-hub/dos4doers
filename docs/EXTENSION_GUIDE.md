# DOs 4 DOERs Browser Extension Guide

Save any webpage to DOs 4 DOERs with a single click! This guide covers installation, configuration, and usage for Chrome, Edge, and Firefox.
...
2. **Extract the Files**
   ...
   - Select "Extract All..."
   - Choose a permanent location (e.g., `Documents/DOs 4 DOERs-Extension`)
...
6. **Pin the Extension** (Optional but Recommended)
   ...
   - Find "DOs 4 DOERs" in the list
   - Click the pin icon to keep it visible

✅ **Done!** The DOs 4 DOERs icon should now appear in your toolbar.
...
1. **Click the DOs 4 DOERs icon** in your browser toolbar
2. You'll see the extension popup
3. **Paste your API token** in the "API Token" field
4. Click **"Save"**

✅ **You're all set!** The extension is now connected to your DOs 4 DOERs account.
...
2. Click the **DOs 4 DOERs icon** in your toolbar
...
2. Select **"Save to DOs 4 DOERs"** from the context menu
3. The page is saved!
...
2. Select **"Save Link to DOs 4 DOERs"**
...
When you save a page, DOs 4 DOERs automatically captures:
- **Title**: Page title
...
- Saved items appear in your DOs 4 DOERs inbox immediately
...
2. Verify your DOs 4 DOERs URL is correct
...
**Solutions**:
1. Go to DOs 4 DOERs Settings → Developer Access
...
**Problem**: Can't find the DOs 4 DOERs icon

**Solutions**:
1. Click the puzzle icon in your toolbar
2. Find "DOs 4 DOERs" in the list
...
2. Verify the DOs 4 DOERs URL is accessible
...
1. Run DOs 4 DOERs locally: `npm run dev`
